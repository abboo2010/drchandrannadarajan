...
const UI = {
  ...
  expMdLabel: {en:'Years as Medical Doctor', bm:'Tahun sebagai Doktor Perubatan', zh:'年医生资历'},
  expIrLabel: {en:'Years as Interventional Radiologist', bm:'Tahun sebagai Pakar Radiologi Intervensi', zh:'年介入放射科医生'},
  expCrLabel: {en:'Years as Clinical Radiologist', bm:'Tahun sebagai Pakar Radiologi Klinikal', zh:'年临床放射科医生'},
  yearsExperienceNum: {en:'20+', bm:'20+', zh:'20+'},
  proceduresNum: {en:'5000+', bm:'5000+', zh:'5000+'},
  patientsTreatedNum: {en:'10000+', bm:'10000+', zh:'10000+'},
  ...
  notSureTitle: {en:'Not sure what you need?', bm:'Tidak pasti apa yang anda perlukan?', zh:'不确定需要哪种治疗？'},
  notSureText: {en:'Tell us your symptoms and our team will guide you to the right doctor or treatment.', bm:'Beritahu kami gejala anda dan pasukan kami akan membimbing anda ke doktor atau rawatan yang sesuai.', zh:'告诉我们您的症状，我们的团队会引导您找到合适的医生或治疗。'},
  notSureBtn: {en:'Ask on WhatsApp', bm:'Tanya di WhatsApp', zh:'WhatsApp 咨询'},
  filterAll: {en:'All', bm:'Semua', zh:'全部'},
  suitableFor: {en:'Suitable for:', bm:'Sesuai untuk:', zh:'适用于：'},
  emergencyTitle: {en:'Sudden symptoms?', bm:'Gejala tiba-tiba?', zh:'突发症状？'},
  emergencyNote: {en:'Go to the nearest emergency department immediately.', bm:'Pergi ke jabatan kecemasan yang terdekat dengan segera.', zh:'请立即前往最近的急诊部门。'},
